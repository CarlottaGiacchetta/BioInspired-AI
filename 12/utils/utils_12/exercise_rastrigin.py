...
def main(NO_BINS, MAX_ITEMS_BIN, BUDGET, BATCH_SIZE, PROBLEM_DIM, seed =None):

    # Find random seed
    if seed is None:
        seed = np.random.randint(1000000)
    
    os.makedirs("results/ex1/"+str(seed))
    ...
    grid = containers.Grid(shape=(NO_BINS,NO_BINS), max_items_per_bin=MAX_ITEMS_BIN, fitness_domain=((0., 1.),), features_domain=((0., 1.), (0., 1.)))
    ...
    logger = algorithms.TQDMAlgorithmLogger(algo, log_base_path="results/ex1/"+str(seed))
